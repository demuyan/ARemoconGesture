...
LOCAL_CFLAGS := -I$(LOCAL_PATH)/stlport/stlport -I$(LOCAL_PATH)/stlport/src

LOCAL_LDLIBS := -L$(SYSROOT)/usr/lib -ldl

LOCAL_CPP_EXTENSION := .cpp

LOCAL_SRC_FILES := $(addprefix stlport/src/,$(notdir $(wildcard $(LOCAL_PATH)/stlport/src/*.cpp $(LOCAL_PATH)/stlport/src/*.c))))
...
LOCAL_LDLIBS := -ldl -llog \
                -L$(LOCAL_PATH)/../obj/local/armeabi -lcxcore -lcv -lcvml -lcvhighgui -lcvblob -lstlport
...
LOCAL_STATIC_LIBRARIES := cvblob stlport cxcore cv cvml cvhighgui
